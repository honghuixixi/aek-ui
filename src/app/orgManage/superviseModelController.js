...
.controller('superviseModelController', ['$scope', '$stateParams', '$rootScope', '$state', '$timeout', '$localStorage', function($scope, $stateParams, $rootScope, $state, $timeout, $localStorage) {
    ...
    $scope.getList = function () {
        ...
        $.ajax({
            type:'get',
            url:'/sys/tenantModule/tenant/'+$stateParams.id+'?moduleType='+$scope.moduleType,
