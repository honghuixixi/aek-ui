'use strict';
angular.module('app').controller('superviseOrgNewController', ['$scope' ,'$stateParams', '$rootScope', '$state', '$timeout', '$localStorage', '$http','$filter', function($scope, $stateParams, $rootScope, $state, $timeout, $localStorage,$http,$filter) {
