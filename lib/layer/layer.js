...
Class.pt.offset = function(height){
  var that = this, config = that.config, layero = that.layero;
  var area = [layero.outerWidth(), height||layero.outerHeight()];
...
Class.pt.tips = function(){
  ...
  goal.where = [function(){ //上        
    ...
    goal.tipTop = goal.top + goal.height/2 - 38;
...
ready.run = function(_$){
  ...
  layer.open = function(deliver){
    ...
    return deliver.autoHeight?o:o.index;
  };
};
