angular.module('app')
    .controller('meteringArchivesController', ['$rootScope', '$scope', '$stateParams', '$localStorage', '$state', 'meteringDbService', 'meteringUtilService', function ($rootScope, $scope, $stateParams, $localStorage, $state, meteringDbService, meteringUtilService) {
        $scope.$parent.checkLimit('archives', function () {
            ...
            $scope.methods = {
                ...
                getAndDisReport: function (obj) {
                    meteringDbService.getReport(obj.infoId, function (json) {
                        json.msCheckHistory = json.msCheckHistory || {};
                        json.msCheckResultInfo = json.msCheckResultInfo || {};
                        json.msCheckResultInfo.files = json.msCheckResultInfo.files ? JSON.parse(json.msCheckResultInfo.files) : [];
                ...
                getAssets: function (pageNo, pageSize) {
                    ...
                    meteringDbService.getArchives(param, function (json) {
