angular.module('app')
    ...
    .controller('dashbordController', ['$scope', '$stateParams', '$rootScope', '$state', '$timeout', '$localStorage', function ($scope, $stateParams, $rootScope, $state, $timeout, $localStorage) {
        var dt = new Date();
        ...
        $scope.data = {
            server: {
                ...
                inspectionPlanTotalYear: 0, // 年度区域计划总数
        ...
        $scope.methods = {
            ...
            drawChart: function () {
                ...
                drawBar('巡检设备总数', catalog[$scope.data.local.type], fillData())
            },
            getData: function () {
                $.ajax({
                    type: 'GET',
                    url: '/data/qcInspectionData/getQcData',
                    data: {},
